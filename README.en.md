...
| Single-axis position feedback | M4 shoulder AS5600 absolute-angle sensing, magnet/sensor health checks, bounded 230-245 deg closed-loop targets, HTTP/dashboard/ROS2 telemetry, and physical convergence evidence |
