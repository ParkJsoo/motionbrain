...
아래 썸네일을 클릭하면 최종 데모 영상을 볼 수 있다. 영상은 물리 텔레오퍼레이션 데모와 `MotionBrain Control` UI 확인까지만 포함한다.

[![MotionBrain 데모 영상](docs/assets/demo/motionbrain-demo-preview.jpg)](docs/assets/demo/motionbrain-demo.mp4)
