...
def generate_launch_description() -> LaunchDescription:
    ...
    urdf_path = package_share / "urdf" / "motionbrain_hardware_interface.urdf"
    ...
    return LaunchDescription(
        [
            DeclareLaunchArgument(
                ...
                default_value="true",
                description="Load and activate open-loop ros2_control controllers.",
            ),
            Node(
                package="robot_state_publisher",
                executable="robot_state_publisher",
                name="motionbrain_hardware_robot_state_publisher",
                output="screen",
