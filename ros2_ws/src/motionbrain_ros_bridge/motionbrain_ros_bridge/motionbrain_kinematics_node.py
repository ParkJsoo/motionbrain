...
class MotionBrainKinematicsNode(Node):
    def __init__(self) -> None:
        ...
        self.get_logger().info(
            f"Publishing FK pose on {pose_topic} and kinematics JSON on {kinematics_topic} "
    ...
    def handle_joint_state(self, message: JointState) -> None:
        ...
        if bool(self.get_parameter("enable_ik_suggestion").value):
        ...
        json_message = String()
        json_message.data = compact_json(payload)
