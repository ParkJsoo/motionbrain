...
PHYSICAL_MODE="${MOTIONBRAIN_PHYSICAL_MODE:-false}"
CONTROL_GUARD_REQUIRE_ARMED="${MOTIONBRAIN_CONTROL_GUARD_REQUIRE_ARMED:-${PHYSICAL_MODE}}"
CONTROL_GUARD_REQUIRE_DETECTION="${MOTIONBRAIN_CONTROL_GUARD_REQUIRE_DETECTION:-${PHYSICAL_MODE}}"
MISSION_SUPERVISOR_AUTOSTART="${MOTIONBRAIN_MISSION_SUPERVISOR_AUTOSTART:-true}"
ENABLE_M4_WRITE_EXECUTOR="${MOTIONBRAIN_ENABLE_M4_WRITE_EXECUTOR:-true}"
...
launch_args=(
  ...
  "control_guard_require_armed:=${CONTROL_GUARD_REQUIRE_ARMED}"
  "control_guard_require_detection:=${CONTROL_GUARD_REQUIRE_DETECTION}"
  "mission_supervisor_autostart:=${MISSION_SUPERVISOR_AUTOSTART}"
  "enable_m4_write_executor:=${ENABLE_M4_WRITE_EXECUTOR}"
)
